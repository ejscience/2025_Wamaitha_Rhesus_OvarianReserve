...
#Integration
embryo_list <- list(Object_name1 = emb_32, 
                    Object_name2 = emb_21,
                    Object_name3 = emb_20)
...
cells_1 <- c("ATTAGATAAGACGGCG-1_1",
             ...
             "CTTAGCTACGCAAGGT-1_1",
             "TATGACAATGCTTGAA-1_1",
             "TGCCTAAGTTAATTAT-1_1",
             "ATACGCTGAGATCAGA-1_1",
             "TATCCACTTGCGTATC-1_1",
             "TCTTAGTCGTCTCGGC-1_1",
             "CGACAATTATTCTGTC-1_1",
             "CGTCAAGGCGGAATGT-1_1",
             "GAGGTGCATTCGGATC-1_1",
             "GCCAGTAGACGATACC-1_1")

Idents(embryo.integrated, cells_1) <- "Ovary_32"
...
de_markers <- FindMarkers(embryo.integrated, ident.1 = "Ovary_32", ident.2 = "Ovary_20")
write.csv(de_markers, file = "~/Desktop/NEW_Visium_Rm/Results/embryo.integrated_Ovary_32_vs_Ovary_20.csv")

de_markers <- FindMarkers(embryo.integrated, ident.1 = "Ovary_32", ident.2 = "Ovary_21")
write.csv(de_markers, file = "~/Desktop/NEW_Visium_Rm/Results/embryo.integrated_Ovary_32_vs_Ovary_21.csv")
