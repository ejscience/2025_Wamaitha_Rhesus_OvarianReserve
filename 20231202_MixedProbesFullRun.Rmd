...
emb177 <- Load10X_Spatial(data.dir = "/mnt/newusb/rojas/spatialtranscriptomics/spaceranger_outs/RhMa_spacerangerOuts-MIXEDprobes/emb177/outs/")
...
seurat_objects <- list(emb019, emb020, emb021, emb022, emb029, emb177, emb031, emb032) 
...
emb177 <- DefaultSeuratProcessing(emb177)
...
I used the gene set lists from Sissy see below:

- Germ_cells = c("DDX4", "DAZL", "NANOG", "POU5F1", "PRDM1", "SMC1B", "SOX17", "SYCP3", "TFAP2C", "NANOS3", "ZP3"),
- Early_progenitor = c("GATA2", "GATA3", "NR2F2", "PDGFRA", "DCN", "TCF21"),
- Granulosa = c("FOXL2", "KRT18", "KRT19", "LHX2", "LHX9", "NR1H4", "UPK3B", "WNT6", "AMH", "FSHR"),
- Early_granulosa = c("LGR5", "NR5A1", "OSR1", "RUNX1", "TAC1", "TSPAN8"),
- Theca = c("CYP17A1", "ASPN", "INSL3"), **NOTE: I used ASPN as you mentioned "PLAP1" in parenthesis, correct this if needed**
- Endothelial = c("HEY1", "KDR", "VWF", "PECAM1"),
- Macrophage = c("CD14", "CD68", "MARCO"),
- NKT_cells = c("CD3D", "KLRB1", "ZBTB16"),
- Smooth_muscle_cells = c("ACTA2", "CNN1", "MYLK4"),
- Other_GeneSet = c("AMHR2", "NR0B1", "STAR", "DPPA4", "LIN28A", "KISS1", "CRYM", "GREB1", "DUOX2", "UTF1", "GSTA3")
- Newest_Geneset = c("PAX8", "GATM", "GREB1")
...
gene_sets <- list(
  ...
  Smooth_muscle_cells = c("ACTA2", "CNN1", "MYLK4"),
  Other_GeneSet = c("AMHR2", "NR0B1", "STAR", "DPPA4", "LIN28A", "KISS1", "CRYM", "GREB1", "DUOX2", "UTF1", "GSTA3"),
  Newest_Geneset = c("PAX8", "GATM", "GREB1","FOXL2"),
  More_New_Geneset = c("EMX2", "IFI6", "SOX9", "SRY", "GATA4")
)
```
...
embryos <- list(emb019 = emb019, emb020 = emb020, emb021 = emb021, emb022 = emb022, emb029 = emb029, emb177 = emb177, emb031 = emb031, emb032 = emb032)
