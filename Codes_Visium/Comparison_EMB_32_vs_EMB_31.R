...
de_markers <- FindMarkers(embryo.integrated, ident.1 = "Gonad_1", ident.2 = "Gonad_2")
write.csv(de_markers, file = "~/Desktop/NEW_Visium_Rm/Results/embryo.integrated_Gonad_31_vs_Gonad_32.csv")
